...
class District(models.Model):
	...
	class Meta:
		db_table = 'districts'
		constraints = [
			models.UniqueConstraint(fields=['province', 'name'], name='unique_district_per_province'),
		]
...
class Municipality(models.Model):
	...
	class Meta:
		...
		constraints = [
			models.UniqueConstraint(fields=['district', 'name'], name='unique_municipality_per_district'),
		]
...
class StudentProfile(models.Model):
	...
	grade = models.ForeignKey(Grade, on_delete=models.PROTECT, related_name='student_profiles')
	province = models.ForeignKey(Province, on_delete=models.PROTECT, related_name='student_profiles')
	district = models.ForeignKey(District, on_delete=models.PROTECT, related_name='student_profiles')
	municipality = models.ForeignKey(Municipality, on_delete=models.PROTECT, null=True, blank=True, related_name='student_profiles')
	school = models.ForeignKey(School, on_delete=models.PROTECT, null=True, blank=True, related_name='student_profiles')
...
class InstructorProfile(models.Model):
	...
	province = models.ForeignKey(Province, on_delete=models.PROTECT, null=True, blank=True, related_name='instructor_profiles')
	district = models.ForeignKey(District, on_delete=models.PROTECT, null=True, blank=True, related_name='instructor_profiles')
	municipality = models.ForeignKey(Municipality, on_delete=models.PROTECT, null=True, blank=True, related_name='instructor_profiles')
	school = models.ForeignKey(School, on_delete=models.PROTECT, null=True, blank=True, related_name='instructor_profiles')
	qualification = models.CharField(max_length=255)
	subject_expertise = models.TextField()
	experience_years = models.DecimalField(max_digits=5, decimal_places=2)
